...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 28 Jun 2020 pada 04.43
...
--
-- Struktur dari tabel `food_diary`
--
...
--
-- Dumping data untuk tabel `food_diary`
--

INSERT INTO `food_diary` (`id_food`, `nama`, `jenis`, `kalori`, `id_user`, `tanggal`) VALUES
(3, 'Soto', 1, 2000, 1, '2020-06-22'),
(6, 'lodeh', 1, 500, 1, '2020-06-24');
...
CREATE TABLE `olahraga` (
  ...
  `durasi` varchar(32) NOT NULL,
  `kalori` varchar(32) NOT NULL,
  `jenis` varchar(1) NOT NULL DEFAULT 'u',
...
INSERT INTO `olahraga` (`no`, `nama`, `durasi`, `kalori`, `jenis`, `link`) VALUES
(1, 'Berenang', '', '', 'u', ''),
(2, 'Angkat Beban', '', '', 'u', 'https://youtu.be/DXjpcG2y7ek'),
(3, 'Push Up', '', '', 'u', 'https://youtu.be/rjc0O7OXS3g'),
(4, 'Squat', '', '', 'u', 'https://youtu.be/aclHkVaku9U'),
(5, 'Sit Up', '', '', 'u', 'https://youtu.be/1fbU_MkV7NE'),
(6, 'Zumba', '', '', 'u', 'https://youtu.be/jaGlgUI8Yok'),
(7, 'Lari', '30 menit', '240 - 355 kalori', 'o', 'https://youtu.be/RaZZU5oFzqI'),
(8, 'Renang', '30 menit', '200 - 300 kalori', 'o', ''),
(9, 'Lompat Tali', '30 menit', '230 - 300 kalori', 'u', 'https://youtu.be/6wREO0mfsiE'),
(10, 'Sepeda Statis', '30 menit', '210 - 310 kalori', 'u', 'https://youtu.be/4Hl1WAGKjMc');

-- --------------------------------------------------------

--
-- Struktur dari tabel `riwayat_bb`
--

CREATE TABLE `riwayat_bb` (
...
--
-- Dumping data untuk tabel `riwayat_bb`
--

INSERT INTO `riwayat_bb` (`id_bb`, `id_user`, `bb`, `tanggal`) VALUES
(1, 1, 70, '2020-06-15'),
(2, 1, 75, '2020-06-21'),
(3, 1, 55, '2020-06-24'),
(4, 1, 70, '2020-06-27');
...
--
-- Indeks untuk tabel `riwayat_bb`
--
ALTER TABLE `riwayat_bb`
...
--
-- AUTO_INCREMENT untuk tabel `food_diary`
--
ALTER TABLE `food_diary`
...
--
ALTER TABLE `olahraga`
  MODIFY `no` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT untuk tabel `riwayat_bb`
--
ALTER TABLE `riwayat_bb`
...
--
-- Ketidakleluasaan untuk tabel `food_diary`
--
ALTER TABLE `food_diary`
  ADD CONSTRAINT `food_diary_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Ketidakleluasaan untuk tabel `riwayat_bb`
--
ALTER TABLE `riwayat_bb`
  ADD CONSTRAINT `riwayat_bb_ibfk_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id_user`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
